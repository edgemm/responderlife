...
echo sprintf( __( 'You have received a donation from %s. Their donation is as follows:', 'woocommerce' ), $order->billing_first_name . ' ' . $order->billing_last_name ) . "\n\n";
...
echo __( 'Donor details', 'woocommerce' ) . "\n";
